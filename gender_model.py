# -*- coding: utf-8 -*-
"""
Created on Fri Jan  8 23:19:19 2021
...
path="C:\\Users\yu065_adadcw1\Desktop\parkjeongho\mearchine_learning\deeplearning\cnn\\facial_emotional_gender\\gender_data"
os.chdir(path)
...
os.chdir(path_train)
train_gender=os.listdir()
for i in train_gender:
    path_path=""
...
h=model.fit(train__x,train_y,batch_size=28,epochs=3,validation_split=0.2)
